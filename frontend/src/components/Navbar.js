            ...
            <nav className='flex flex-row h-20 w-full mx-auto border-b-2 border-b-slate-300 border-b-solid'>
                <div className='lg:hidden'>
                    <button onClick={() => {
                        console.log(showNav);
                        setShowNav(!showNav);
                        }}><FontAwesomeIcon icon={faBars} className='py-7 px-3 sm:text-3xl text-lg' /></button>
                </div>
                <div className='flex-none place-content-center'>
                    
                    <img src={dribbbleLogoDark} alt="logo" className='p-2 sm:w-32 w-24 flex-none'/>
                </div>
                ...
                <div className='flex flex-row-reverse place-content-center '>
                    <div className="p-3">
                        <button className='sm:py-3 sm:px-6 py-1 px-3 mt-3 sm:mt-0 bg-pink-400 rounded-lg text-white font-bold place-self-center'>Upload</button>
                    </div>
                    <div className="place-content-center">
                        <img className="sm:size-16 size-14 p-2 rounded-full overflow-hidden min-w-14" src={userProfile.image} alt="profile" />
                    </div>
                    <div className="place-content-center p-2">
                        <FontAwesomeIcon icon={faBriefcase} className='sm:text-3xl text-2xl p-2 text-slate-300' />
                    </div>
                </div>
            </nav>
        </header>
